          ...
          <div className="bg-gray-100 px-5 py-6 md:px-8">
              ...
              <ul className="-my-7 divide-y divide-gray-200">
                  ...
                  <div className="flex flex-1 items-stretch">
                    ...
                    <div className="ml-5 flex flex-col justify-between">
                      <div className="flex-1">
                        <p className="text-sm font-bold">Polo</p>
                ...
                <li className="flex items-stretch justify-between space-x-5 py-7">
                  <div className="flex flex-1 items-stretch">
                    ...
                    <div className="ml-5 flex flex-col justify-between">
                      <div className="flex-1">
                        <p className="text-sm font-bold">White Jersey Polo </p>
                        <p className="mt-1.5 text-sm font-medium text-gray-500">
                          White
                        </p>
                      </div>
            ...
            <ul className="mt-6 space-y-3">
              <li className="flex items-center justify-between text-gray-600">
                ...
                <p className="text-sm font-medium">Tk 14,399</p>
              </li>
              <li className="flex items-center justify-between text-gray-900">
                <p className="text-sm font-medium ">Total</p>
                <p className="text-sm font-bold ">Tk 14,399</p>
              </li>
            </ul>
          </div>
        </div>
